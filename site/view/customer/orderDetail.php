            ...
            <div class="col-md-9 order-info">
                <div class="row">
                    ...
                    <aside class="col-md-7 cart-checkout">
                        <div class="row">
                            <div class="col-xs-2">
                                <img class="img-responsive" src="../images/picture.jpg" alt="Food name">
                            </div>
                            <div class="col-xs-7">
                                <a class="product-name" href="chi-tiet-san-pham.html">Food name</a>
                                <br>
                        ...
                        <div class="row">
                            <div class="col-xs-2">
                                <img class="img-responsive" src="../images/picture.jpg" alt="Kem nền trang điểm dưỡng da Sandras BB 24h- 15ml">
                            </div>
                            <div class="col-xs-7">
                                <a class="product-name" href="chi-tiet-san-pham.html">Food name</a>
                                <br>

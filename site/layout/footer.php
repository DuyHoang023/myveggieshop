                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-4 list">
                        <div class="footerLink">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="#">Món tàu hủ</a></li>
                                <li><a href="#">Món nấm</a></li>
                                <li><a href="#">Món bí đỏ</a></li>
                                <li><a href="#">Món cà tím</a></li>
                                <li><a href="#">Món canh chay</a></li>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-4 list">
                        <div class="footerLink">
                            ...
                            <ul class="list-unstyled">
                                <li>Phone: 0931.347.844</li>
                                <li><a href="mailto:tymweaver3@gmail.com">Mail:
                                        tymweaver3@gmail.com</a></li>
                            </ul>
                        ...
                        <div class="clearfix text-left">
                            <div class="row">
                                <div class="col-sm-6 col-md-1">
                                    <div><img class="img-responsive" src="../upload/tauHuChienSaOt.png" alt="Kem làm trắng da 5 trong 1 Beaumore Secret Whitening Cream "></div>
                                </div>
